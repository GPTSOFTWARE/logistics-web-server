...
export class update111632747865162 implements MigrationInterface {
    name = 'update111632747865162'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "delivery_order" ("id" SERIAL NOT NULL, "saleOrderId" integer NOT NULL, "statusId" integer NOT NULL, "updatedAt" TIMESTAMP WITH TIME ZONE DEFAULT now(), "createdAt" TIMESTAMP WITH TIME ZONE DEFAULT now(), "updatedBy" integer, "createdBy" integer, "deletedAt" TIMESTAMP, "typeShip" "delivery_order_typeship_enum" NOT NULL DEFAULT 'giao hàng tiêu chuẩn', "plannedTime" TIMESTAMP WITH TIME ZONE, "driverid" integer, CONSTRAINT "PK_08f144cd9889759426ab37c358e" PRIMARY KEY ("id"))`);
        await queryRunner.query(`ALTER TABLE "public"."job" ALTER COLUMN "expirationDate" DROP DEFAULT`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "public"."job" ALTER COLUMN "expirationDate" SET DEFAULT now()`);
