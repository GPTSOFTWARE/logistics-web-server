...
export class update11631843039395 implements MigrationInterface {
    name = 'update11631843039395'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "public"."sale_order" DROP CONSTRAINT "FK_5f3eaaa5869ececfe8c6cdb6364"`);
        await queryRunner.query(`ALTER TABLE "public"."sale_order" DROP COLUMN "orderType"`);
        await queryRunner.query(`ALTER TABLE "public"."sale_order" DROP COLUMN "payment"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "public"."sale_order" ADD "payment" integer`);
        await queryRunner.query(`ALTER TABLE "public"."sale_order" ADD "orderType" integer`);
        await queryRunner.query(`ALTER TABLE "public"."sale_order" ADD CONSTRAINT "FK_5f3eaaa5869ececfe8c6cdb6364" FOREIGN KEY ("payment") REFERENCES "payment_method"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
