...
export class initHeroku1631217343852 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "sale_order_header" ("id" SERIAL NOT NULL, "address" character varying NOT NULL, "totalPrice" integer NOT NULL, "totalQuantity" integer NOT NULL, "SOI_id" integer, "Account_id" integer, CONSTRAINT "PK_0ae3ebe595946a9ac9597d22c4e" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "role_enum" AS ENUM('admin', 'user')`);
        await queryRunner.query(`CREATE TABLE "account" ("id" SERIAL NOT NULL, "email" character varying(255) NOT NULL, "password" character varying(255) NOT NULL, "fullname" character varying(50) NOT NULL, "phone" character varying(11) NOT NULL, "role" "role_enum" NOT NULL DEFAULT 'user', CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "chats" ("updatedAt" TIMESTAMP, "createdAt" TIMESTAMP, "updatedBy" integer, "createdBy" integer NOT NULL, "id" SERIAL NOT NULL, "account1_id" integer, "account2_id" integer, CONSTRAINT "PK_0117647b3c4a4e5ff198aeb6206" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "sale_order_header" ADD CONSTRAINT "FK_dd524e2e1185571b43756a9a992" FOREIGN KEY ("Account_id") REFERENCES "account"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "chats" ADD CONSTRAINT "FK_05b8003b6a5c6a9b16cb31fea2a" FOREIGN KEY ("account1_id") REFERENCES "account"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "chats" ADD CONSTRAINT "FK_a14c79d67133bb0df4a71807a74" FOREIGN KEY ("account2_id") REFERENCES "account"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
